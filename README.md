# 智能菜谱中台 - Recipe Visualizer

**当前版本：** V14（2026-03-08 布局重构版）  
**部署链接：** https://recipe-visualizer.vercel.app/index-v14.html  
...
### V14 - 页面布局重构版（2026-03-08）

| 版本 | 日期 | 功能 | 文件 | 状态 |
|------|------|------|------|------|
| V14 | 2026-03-08 | 页面布局重构 - Top Bar + Left Sidebar + Footer 标准布局，三大域视觉标识 | index-v14.html | ✅ 最新 |

**V14 核心变更：**
- ✅ 采用《智能菜谱中台界面规范 v1/v1.1》标准布局
- ✅ Top Bar 全局导航（需求录入/菜谱库/维度管理）
- ✅ Left Sidebar 二级导航（核心功能/分析工具分组）
- ✅ Footer 状态栏（系统状态/版本/菜谱数量）
- ✅ 三大域视觉标识（需求端紫色/交付端青色/控制变量橙色）
- ✅ 统一组件样式（卡片/表格/按钮/标签）
- ✅ 功能完整保留（AI 识别/菜谱列表/瀑布流/维度管理/统计看板）

### V13.2.x 系列 - AI 识图与数据加载完善

| 版本 | 日期 | 功能 | 文件 | 状态 |
|------|------|------|------|------|
| V13.2.6 | 2026-03-07 | 语法修复版 - 修复 JavaScript 语法错误，确保脚本正常执行 | index-v13.2.6.html | ⚠️ 已弃用 |
